                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php } ?>
                                    <form class="row g-3" action="<?= base_url('auth/registration') ?>" method="POST">
                                        <div class="col-12">
                                            <label for="email" class="form-label">Email</label>
                                            <input type="text" name="email" class="form-control" id="email" autocomplete="off" autofocus value="<?= set_value('email') ?>">
                                            <?= form_error('email', '<small class="text-danger pl-3">', '</small>') ?>
                                        </div>

                                        <div class="col-12">
                                            <label for="instansi" class="form-label">Nama Instansi</label>
                                            <input type="text" name="instansi" class="form-control" id="instansi" autocomplete="off" value="<?= set_value('instansi') ?>">
                                            <?= form_error('instansi', '<small class="text-danger pl-3">', '</small>') ?>
                                        </div>
                                        <div class="col-12">
                                            <label for="alamat" class="form-label">Alamat</label>
                                            <input type="text" name="alamat" class="form-control" id="alamat" autocomplete="off" value="<?= set_value('alamat') ?>">
                                            <?= form_error('alamat', '<small class="text-danger pl-3">', '</small>') ?>
                                        </div>
                                        <div class="col-12">
                                            <label for="no_pks" class="form-label">No PKS</label>
                                            <input type="text" name="no_pks" class="form-control" id="no_pks" autocomplete="off" value="<?= set_value('no_pks') ?>">
                                            <?= form_error('no_pks', '<small class="text-danger pl-3">', '</small>') ?>
                                        </div>
                                        <div class="col-12">
                                            <label for="nama_ketua" class="form-label">Nama Ketua Instansi</label>
                                            <input type="text" name="nama_ketua" class="form-control" id="nama_ketua" autocomplete="off" value="<?= set_value('nama_ketua') ?>">
                                        ...
                                        <div class="col-12">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="acceptTerms">I agree and accept the <a href="#" class="link-text">terms and conditions</a></label>
